...
<head>
    ...
    <style>
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 600;
            src: url("{{public_path('/fonts/Gelasio-SemiBold.ttf')}}") format('truetype');
        }
            ...
            <div class="w-100 h-100 box-content">
                <div class="content-body">
                    ...
                    <div class="content-footer">
                        <span class="font-footer text-footer text-left d-block">Verify at littlemonjo.com/verify/{{$generated_hash}}</span>
