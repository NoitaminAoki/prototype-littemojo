    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Skills | SKILLS YOU WILL GAIN</h3>
                ...
                <form wire:submit.prevent="insert">
                    <div class="modal-body">
                        <div class="w-100">
                            ...
                            <textarea wire:model.defer="skill.name" name="name" class="form-control" style="min-height: 80px;" required>
                            </textarea>
                        </div>
                        @error('skill.name')
