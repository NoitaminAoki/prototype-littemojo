...
class CreateCustomerVideoRatingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customer_video_ratings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('customer_video_ratings');
    }
}
