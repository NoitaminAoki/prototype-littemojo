...
class CreateCustomerBookRatingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customer_book_ratings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('customer_book_ratings');
    }
}
